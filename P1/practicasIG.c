...
// buffer de profundidad
  ...
  /*
  1-Colores de cuatro componentes
  2-Usar un buffer para dibujar y otro para meter en pantalla (double)
  3-Guardar profundidades para que no se dibuje lo que esta detras y si lo que esta delante
  */
  glutCreateWindow ("IG. Curso 2022/23. Autor: Manuel Guerrero Mesias");
...
// Funcion de fondo
  ...
  //temporizador, ayuda a medir tiempo (eventos)
...
// Inicializa parametros de openGL
  ...
  glEnable (GL_LIGHT0);
  //funciones para activar iluminacion y otras cosas
  //glDisable para desactivar
